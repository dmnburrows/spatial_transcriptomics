...
plq_cData <- read.csv("old-APP-cortex_plqdist_design.csv", header=TRUE)
...
write.csv(sum_zlmint$datatable, file="old-APP-cortex_plqdist_MAST-LRT_sample-intercept.csv")
...
write.csv(sum_zlmint_slope$datatable, file="old-APP-cortex_plqdist_MAST-LRT_sample-slopeintercept.csv")
